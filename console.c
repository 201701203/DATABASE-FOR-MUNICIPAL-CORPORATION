...
{
    PQexec(conn, "set search_path to municipal_corporation;");
...
int main()
{
  	const char *conninfo = "dbname=201701198 user=201701198 password=201701198 hostaddr=10.100.71.21 port=5432"; // connection  
